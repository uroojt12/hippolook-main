<?php echo getBredcrum(ADMIN, array('#' => 'Our Story')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Our Story</strong></h2>
    </div>
        ...
        <form role="form"  method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="detail" id="detail" rows="4" class="form-control ckeditor" ><?= $row['detail'] ?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-5">
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="max-width: 310px; height: 110px;" data-trigger="fileinput">
                                    <img src="<?= !empty($row['image4']) ? get_site_image_src("images/", $row['image4']) : 'http://placehold.it/3000x1000' ?>" alt="--">
                                </div>
                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 320px; max-height: 160px; line-height: 6px;"></div>
                                <div>
                                    <span class="btn btn-white btn-file">
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="right_heading" class="control-label"> Heading </label>
                            <input type="text" name="right_heading" id="right_heading" value="<?= $row['right_heading'] ?>" class="form-control">
                        </div>
                        <div class="col-md-12">
                            <label for="right_text" class="control-label"> Text </label>
                            <textarea name="right_text" id="right_text" class="form-control" rows="8"><?= $row['right_text'] ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
