...
<head>
    ...
    <script type="text/javascript">
        var scontent_url = "<?= SCONTENT_SITE ?>";
    </script>
</head>
...
<body class="page-body  skin-white">
    ...
    <?php if (isset($enable_editor) && $enable_editor == TRUE) : ?>
        ...
        -->
        <!-- <link href="<?= base_url('assets/summernote/summernote.min.css?v-' . $adminsite_setting->site_version) ?>" rel="stylesheet">
        <script src="<?= base_url('assets/summernote/summernote.min.js?v-' . $adminsite_setting->site_version) ?>"></script> -->
                    ...
                    callbacks: {
                        onImageUpload: function(files) {
                            ...
                            $.ajax({
                                data: data,
                                type: "POST",
                                url: "<?= site_url('ajax/upload_summernote_attach') ?>",
                                cache: false,
                                contentType: false,
                                processData: false,
                        ...
                        onMediaDelete : function(target) {
                            $.ajax({
                                data: {'attach' : target[0].src},
                                type: "POST",
                                url: "<?= site_url('ajax/remove_summernote_attachments') ?>",
                                cache: false,
