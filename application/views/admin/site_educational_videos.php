<?= getBredcrum(ADMIN, array('#' => 'Educational Videos')); ?>
<?= showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Educational Videos</strong></h2>
    </div>
    <div class="col-md-6 text-right">
        <!--        <a href="<?= base_url(ADMIN.'/sitecontent/educational_videos'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>-->
    </div>
</div>
<div>
    <hr>
