<?php echo getBredcrum(ADMIN, array('#' => 'Customer Services')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Customer Services</strong></h2>
    </div>
    <div class="col-md-6 text-right">
        <!--        <a href="<?php echo base_url('admin/customer_service'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>-->
    </div>
</div>
<div>
    <hr>
        ...
        <form role="form"  method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-group col-sm-12 ">
                    ...
                    <textarea name="detail" id="detail" rows="8" class="form-control ckeditor" ><?= $content->full_code ?></textarea>
                </div>
            </div>
            <div class="form-group">
