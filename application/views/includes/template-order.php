							...
							<tr>
								<td>
									<a href="<?= base_url(); ?>" target="_blank" style="display: block; width: 140px; margin: -10px 0;">
										<img src="<?= base_url('assets/images/logo.png') ?>" alt="<?= $site_settings->site_name ?> Email Logo" style="display: block; width: 100%;" />
									</a>
								</td>
		...
		<tbody>
			<tr>
				<td style="padding: 30px 40px 0;">
					<table width="100%" cellspacing="0" cellpadding="0" style="background: #ecfbfb; padding: 0 20px 20px; border: 1px solid #0f0f0f;">
						<tbody>
							<tr>
								<td style="background: #fff; font-size: 44px; border: 1px solid #0f0f0f; border-top: 0; padding: 15px; -webkit-text-stroke: 5px #0f0f0f; letter-spacing: 2.5px;">
									<strong>
										YOUR ORDER <br />
										HAS BEEN <?= $mem_data['order_status'] ?>
									</strong>
								</td>
							</tr>
						</tbody>
						...
						<tbody>
							<tr valign="top">
								...
								<td style="padding-left: 20px;">
									<?= $mem_data['row']->ship_fname ?> <?= $mem_data['row']->ship_lname ?> <br />
									<?= $mem_data['row']->ship_address ?> <?= $mem_data['row']->ship_house_number ?> <br />
									<?= $mem_data['row']->ship_zip ?> <br />
									<?= $mem_data['row']->ship_country ?> <br />
									<?= $mem_data['row']->contact_email ?>* <br />
									<?= $mem_data['row']->ship_phone ?>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table width="100%" cellspacing="0" cellpadding="0" style="border: 0; border-bottom: 1px solid #0f0f0f; padding: 20px 0;">
						<tbody>
							<tr style="-webkit-text-stroke: 0.5px #0f0f0f;">
								...
								<td style="padding-left: 20px; padding-bottom: 10px; text-align: center;">Product name</td>
								<!-- <td style="padding-left: 20px; padding-bottom: 10px; text-align: center;">Size</td> -->
								<td style="padding-left: 20px; padding-bottom: 10px; text-align: center;">Shape</td>
							...
							?>
								<tr>
									<td style="color: #279b9b; padding-bottom: 20px;"><?= $pro->id ?></td>
									...
									<td style="padding-left: 20px; padding-bottom: 20px; text-align: center;"><?= $pro->shape ?></td>
						...
						<tfoot>
							...
							<tr style="-webkit-text-stroke: 0.5px #0f0f0f;">
								...
								<td colspan="3" style="padding-left: 20px; padding-top: 20px; text-align: center;">Total NET</td>
							...
							<tr>
								...
								<!-- <td colspan="3" style="padding-left: 20px; padding-top: 10px; text-align: center;"><?= format_amount($mem_data['row']->product_total) ?></td> -->


								<td colspan="3" style="padding-left: 20px; padding-top: 10px; text-align: center;"><?= format_amount($sub_total) ?></td>
