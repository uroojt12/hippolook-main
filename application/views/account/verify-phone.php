...
<head>
    <title>Phone Verification — <?= $site_settings->site_name ?></title>
...
<body id="home-page">
    ...
    <main common phone>
        ...
        <section id="verify">
            <div class="contain">
                <div class="inBlk">
                    <h2 class="heading"><?= $site_content['pverify_heading'] ?></h2>
                    <div id="resndCntnt">
                        <p>Your Phone Number is <strong class="color"><?= $mem_data->mem_phone ?></strong></p>
                        <p><?= $site_content['pverify_detail'] ?></p>
                        <p><a href="javascript:void(0)" class="vrfPhn">Verify Phone</a> OR <a href="javascript:void(0)" class="popBtn" data-popup="change-phone">Change Phone</a>
                        </p>
                    </div>
                                    ...
                                    <div class="_inner">
                                        ...
                                        <form action="<?= site_url('change-phone') ?>" method="post" autocomplete="off" class="frmAjax" id="frmPhone">
                                            ...
                                            <div class="bTn text-center">
                                                <button type="submit" class="webBtn">Change your Phone <i class="spinner hidden"></i></button>
                                            </div>
                                ...
                                <div class="contain">
                                    <div class="_inner">
                                        ...
                                        <form action="" method="post" autocomplete="off" class="frmAjax" id="frmPhonevld">
                                            <input type="hidden" name="ppup" value="">
                                            <div class="txtGrp">
                                                <ul class="phoneLst">
                                                    <?php for ($i = 0; $i < 6; $i++) : ?>
                                                        <li>
                                            ...
                                            <div class="bTn text-center">
                                                <button type="submit" class="webBtn">Verify <i class="spinner hidden"></i></button>
                                            </div>
                                            <div class="alertMsg" style="display:none"></div>
                                        </form>
                                    </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on('click', 'a.vrfPhn', function(e) {
                ...
                $('.alertMsg').html('');
                $('#frmPhonevld div.showCode').slideUp();
                if (confirm("To make sure that <?= $mem_data->mem_phone ?> is yours, <?= $site_settings->site_name ?> is going to send you a text message with a 6-digit verification code.")) {
